...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i =0; i<[weekdays count]; i++) {
        ...
        UIFont *font = [UIFont mainFontWithSize:12.0f];
...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        [date drawInRect:CGRectMake(targetX+2, targetY+10, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withFont:[UIFont mainFontWithSize:20] lineBreakMode:UILineBreakModeClip alignment:UITextAlignmentCenter];
...
-(UIImage *)drawCurrentState {
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(kVRGCalendarViewWidth, targetHeight-kVRGCalendarViewTopBarHeight), NO, 0.0f);
