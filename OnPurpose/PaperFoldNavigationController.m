...
- (id)initWithRootViewController:(UIViewController*)rootViewController
{
    ...
    if (self) {
        ...
        _paperFoldView.timerStepDuration = PAPERFOLDSPEED;
    }
    return self;
}
...
- (void)setLeftViewController:(UIViewController *)leftViewController width:(float)width
{
    ...
    [self.paperFoldView setLeftFoldContentView:self.leftViewController.view foldCount:1 pullFactor:0.9];
}
