...
@interface DailySpaceCell : UITableViewCell <TDRatingViewDelegate, ASValueTrackingSliderDelegate, ASValueTrackingSliderDataSource>
...
@property (strong, nonatomic) CWRatingView *ratingView;
